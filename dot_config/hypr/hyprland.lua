...
hl.monitor({ output = "DP-1", mode = "2560x1440@59.951", position = "2560x0", scale = 1, transform = 1 })
...
local fileManager = "kitty --hold -T superfile spf"
...
hl.config({
    misc = {
        force_default_wallpaper = 0,    -- Set to 0 or 1 to disable the anime mascot wallpapers (hyprpaper handles wallpapers)
